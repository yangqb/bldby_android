...
public class PlaneDetailAdapter extends BaseMultiItemQuickAdapter<MultiPriceInfo, BaseViewHolder> {
    public PlaneDetailAdapter(@Nullable List<MultiPriceInfo> data) {
        super(data);
        addItemType(MultiPriceInfo.DOMESTIC_TYPE, R.layout.item_layout_plane_detail);
        addItemType(MultiPriceInfo.DOMESTIC_GO_BACK_TYPE, R.layout.item_layout_plane_detail);
        addItemType(MultiPriceInfo.INTERNATIONAL_TYPE, R.layout.item_layout_plane_detail);
    }
    ...
    protected void convert(@NonNull BaseViewHolder helper, MultiPriceInfo item) {
        ...
        if (helper.getItemViewType() == MultiPriceInfo.DOMESTIC_TYPE) {
            ...
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.venDorsInfo.zk, item.venDorsInfo.barePrice))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.venDorsInfo.zk, item.venDorsInfo.barePrice))));
            ...
            helper.setText(R.id.cabinCount, "");
            helper.setGone(R.id.cabinCount, false);
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.internationalPriceInfo.zk, item.internationalPriceInfo.price))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.internationalPriceInfo.zk, item.internationalPriceInfo.price))));
            ...
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.goBackVendors.zk, item.goBackVendors.barePrice))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.goBackVendors.zk, item.goBackVendors.barePrice))));
        }
    }
