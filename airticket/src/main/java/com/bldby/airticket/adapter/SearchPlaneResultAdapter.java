...
public class SearchPlaneResultAdapter extends BaseMultiItemQuickAdapter<MultipleGoSearchFightInfo, BaseViewHolder> {
    ...
    public SearchPlaneResultAdapter(List<MultipleGoSearchFightInfo> data) {
        super(data);
        addItemType(MultipleGoSearchFightInfo.DOMESTIC_TYPE, R.layout.item_layout_plane_result);
        addItemType(MultipleGoSearchFightInfo.INTERNATIONAL_TYPE, R.layout.item_layout_plane_result);
    }
    ...
    protected void convert(@NonNull BaseViewHolder helper, MultipleGoSearchFightInfo item) {
        ...
        if (helper.getItemViewType() == MultipleGoSearchFightInfo.DOMESTIC_TYPE) {
            ...
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.flightModel.zk, item.flightModel.barePrice))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.flightModel.zk, item.flightModel.barePrice))));
        } else {
            helper.setText(R.id.tv_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.internationalFlightModel.zk, item.internationalFlightModel.price))));
            helper.setText(R.id.vip_rebate, "奖励¥" + MathUtils.subZero(String.valueOf(MathUtils.multiply(item.internationalFlightModel.zk, item.internationalFlightModel.price))));
            ...
            helper.setText(R.id.flightTimes, DateUtil.minToHour(item.internationalFlightModel.goTrip.duration));
