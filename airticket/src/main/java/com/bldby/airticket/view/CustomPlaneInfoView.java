...
public class CustomPlaneInfoView extends CenterPopupView {
    private int type;
    private CustomAirPriceDetailInfo detailInfo;
    ...
    public CustomPlaneInfoView setData(CustomAirPriceDetailInfo detailInfo) {
    ...
    protected void onCreate() {
        ...
        if (type == 0) {
            String date = DateUtil.strToStr(detailInfo.customDocGoFlightInfo.date) + DateUtil.strToWeek("yyyy-MM-dd", detailInfo.customDocGoFlightInfo.date);
            ...
            String date = DateUtil.strToStr(interGo.flightSegments.get(0).depDate) + DateUtil.strToWeek("yyyy-MM-dd", interGo.flightSegments.get(0).depDate);
            ...
            goFlightTimes.setText(DateUtil.minToHour(interGo.duration));
        } else if (type == 2) {
            String goDate = DateUtil.strToStr(detailInfo.customFightCityInfo.goDate) + DateUtil.strToWeek("yyyy-MM-dd", detailInfo.customFightCityInfo.goDate);
            String backDate = DateUtil.strToStr(detailInfo.customFightCityInfo.backDate) + DateUtil.strToWeek("yyyy-MM-dd", detailInfo.customFightCityInfo.backDate);
            ...
            GoBackTripInfo interGo = detailInfo.customInterFlightInfo.goTrip;
            String goDate = DateUtil.strToStr(interGo.flightSegments.get(0).depDate) + DateUtil.strToWeek("yyyy-MM-dd", interGo.flightSegments.get(0).depDate);
            ...
            String backDate = DateUtil.strToStr(interBack.flightSegments.get(0).depDate) + DateUtil.strToWeek("yyyy-MM-dd", interBack.flightSegments.get(0).depDate);
            ...
            backFlightTimes.setText(DateUtil.minToHour(interBack.duration));
        }
