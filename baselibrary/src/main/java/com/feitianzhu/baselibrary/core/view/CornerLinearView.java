...
public class CornerLinearView extends LinearLayout {
    ...
    public CornerLinearView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBottomLeftCornerRadius = typedArray.getBoolean(R.styleable.CornerLinearView_isBottomLeftRadius, true);

        mBottomRightCornerRadius = typedArray.getBoolean(R.styleable.CornerLinearView_isBottomRightRadius, true);

        mTopLeftCornerRadius = typedArray.getBoolean(R.styleable.CornerLinearView_isTopLeftRadius, true);
        mTopRightCornerRadius = typedArray.getBoolean(R.styleable.CornerLinearView_isTopRightRadius, true);
        typedArray.recycle();
