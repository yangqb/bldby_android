...
public class MainAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        final MainStarViewHolder mainStarHolder = (MainStarViewHolder) viewHolder;
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        ...
                        switch (orientation) {
                            case 'r':       //向右滑动
                                ...
                                return true;
                            case '0':   //点击
                                mainStarHolder.mViewPager.setCurrentItem(mainStarHolder.mViewPager.getCurrentItem()-1,true);return true;
                            case 'l':       //向左滑动
                                return true;
                        }
                        break;
