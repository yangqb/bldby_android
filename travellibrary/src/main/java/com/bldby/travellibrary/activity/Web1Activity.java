...
import com.bldby.travellibrary.activity.base.SFActivity;
...
public class Web1Activity extends SFActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayout containerccc = findViewById(R.id.containerccc);
        RelativeLayout left_button = findViewById(R.id.left_button);
        TextView title_name = findViewById(R.id.title_name);
        ButterKnife.bind(this);
        title_name.setText("支付详情");
        ...
        mAgentWeb = AgentWeb.with(this)//传入Activity or Fragment
                .setAgentWebParent(containerccc, new LinearLayout.LayoutParams(-1, -1))//传入AgentWeb 的父控件 ，如果父控件为 RelativeLayout ， 那么第二参数需要传入 RelativeLayout.LayoutParams ,第一个参数和第二个参数应该对应。
